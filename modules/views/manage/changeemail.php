        ...
        <div id="pad-wrapper" class="new-user">
            ...
            <div class="row-fluid form-wrapper">
                ...
                <div class="span9 with-sidebar">
                    ...
                    <div class="container">
                        <?php if(Yii::$app->session->getFlash('info')){ echo "<span style='color: red'>".Yii::$app->session->getFlash('info')."</span>";}?>
                        ...
                        <?php echo $form->field($model, 'adminuser')->textInput(['class' => 'span9','disable'=>true]); ?>
                        ...
                        <div class="span11 field-box actions">
                            <?php echo \yii\helpers\Html::submitButton('修改',['class'=>'btn-glow primary'])?>
                            <span>或者</span>
